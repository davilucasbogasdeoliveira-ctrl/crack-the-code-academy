...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Code Academy — Cursos aprofundados de Python e C/C++" },
      { name: "description", content: "Curso fechado e aprofundado de Python e C/C++. Do zero ao nível de crack: internals, performance, concorrência, projetos reais e preparação para entrevistas." },
      { property: "og:title", content: "The Code Academy — Cursos aprofundados de Python e C/C++" },
      { property: "og:description", content: "Curso fechado e aprofundado de Python e C/C++. Do zero ao nível de crack: internals, performance, concorrência, projetos reais e preparação para entrevistas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "The Code Academy — Cursos aprofundados de Python e C/C++" },
      { name: "twitter:description", content: "Curso fechado e aprofundado de Python e C/C++. Do zero ao nível de crack: internals, performance, concorrência, projetos reais e preparação para entrevistas." },
