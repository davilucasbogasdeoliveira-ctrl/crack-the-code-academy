...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CrackDev — Cursos aprofundados de Python e C/C++" },
      ...
      { property: "og:title", content: "CrackDev — Cursos aprofundados de Python e C/C++" },
      ...
      { name: "twitter:title", content: "CrackDev — Cursos aprofundados de Python e C/C++" },
