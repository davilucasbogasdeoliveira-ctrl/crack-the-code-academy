...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Ferramentas do curso CrackDev (Python, C/C++, HTML, CSS, Java). Use `list_modules` para ver os módulos, `get_module_content` para ler um módulo (requer assinatura ativa) e `my_access` para checar o status da assinatura do aluno conectado.",
